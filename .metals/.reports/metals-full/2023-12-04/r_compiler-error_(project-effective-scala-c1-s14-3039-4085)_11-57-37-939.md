file://<WORKSPACE>/src/main/scala/startup/Ast.scala
...
action parameters:
offset: 7613
uri: file://<WORKSPACE>/src/main/scala/startup/Ast.scala
text:
```scala
package startup.ast
...
object ExpressionToSerialize:
  ...
  given [T](using RW[T]): Either[String, RW[ExpressionToSerialize[T]]] =
    RW.merge(
      summon[RW[String]].bimap[Either[String, RW[ExpressionToSerialize[T]]]]({c@@}, Left(_)),
      summon[ExpressionToSerialize[T]]
    )
