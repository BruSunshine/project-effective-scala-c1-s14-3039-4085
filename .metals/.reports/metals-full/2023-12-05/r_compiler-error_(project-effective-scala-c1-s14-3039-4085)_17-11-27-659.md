...
### dotty.tools.dotc.ast.Trees$UnAssignedTypeException: type of Apply(Select(New(Select(Ident(cask),postJson)),<init>),List(Literal(Constant(/jsonastvalid)))) is not assigned
...
object FormPost extends cask.Routes:
  ...
  //  jsonStr
  @cask.postForm("/evaluate1")
  def evaluate1(argast: ujson.Value): Int =
